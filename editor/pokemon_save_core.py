...
ROM_SPECIES_COUNT = PROFILE.name_tables[0].count
ROM_MOVE_COUNT = PROFILE.name_tables[1].count
...
LEVEL_UP_LEARNSET_POINTERS_OFFSET = CREATURE_PROFILE.level_up_learnset_pointers_offset
LEVEL_UP_LEARNSET_SPECIES_OFFSET = CREATURE_PROFILE.level_up_learnset_species_offset
EVOLUTIONS_OFFSET = CREATURE_PROFILE.evolutions_offset
EVOLUTION_ENTRY_SIZE = CREATURE_PROFILE.evolution_entry_size
EVOLUTIONS_PER_SPECIES = CREATURE_PROFILE.evolutions_per_species
EVOLUTION_RECORD_SIZE = EVOLUTION_ENTRY_SIZE * EVOLUTIONS_PER_SPECIES
EGG_MOVES_OFFSET = CREATURE_PROFILE.egg_moves_offset
EGG_MOVE_SPECIES_MARKER_BASE = 20000
TMHM_COMPATIBILITY_OFFSET = CREATURE_PROFILE.tmhm_compatibility_offset
TMHM_COMPATIBILITY_SIZE = CREATURE_PROFILE.tmhm_compatibility_size
TMHM_MOVES_OFFSET = CREATURE_PROFILE.tmhm_moves_offset
TMHM_COUNT = CREATURE_PROFILE.tmhm_count
TUTOR_MOVES_OFFSET = CREATURE_PROFILE.tutor_moves_offset
TUTOR_COMPATIBILITY_OFFSET = CREATURE_PROFILE.tutor_compatibility_offset
TUTOR_COMPATIBILITY_SIZE = CREATURE_PROFILE.tutor_compatibility_size
TMHM_FIRST_ITEM_ID = CREATURE_PROFILE.tmhm_first_item_id
